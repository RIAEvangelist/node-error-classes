...
class UndefinedValue extends Error{
   ...
   */
    setMessage(variableName, variable){
        this.name = 'Undefined';
        this.message = `Expected ${util.inspect(variableName, {colors: true})} but to be defined or filled but was ${util.inspect(undefined, {colors: true})} or empty
        ${util.inspect(typeof variable, {colors: true})}`;
        return this.message;
    }
}
